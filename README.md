...
- **Credit Portfolio Vintage Model (Excel)** — monthly portfolio projection by vintage (“cosechas”), valuation inputs, and risk metrics.  
  **Repo:** `credit-portfolio-vintage-model`

- **Tableau & Power BI Dashboards** — KPI design, data storytelling, and business-ready visuals (screenshots + metric definitions).  
  **Repo:** `tableau-powerbi-portfolio`
...
## Contact
- LinkedIn: https://www.linkedin.com/in/ana-gabriela-castro-amaya-387502269  
- Email: anagabicastro@hotmail.com
